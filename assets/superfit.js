...
(function() {
  ...
  Superfit.SearchWods = (function(_super) {
    ...
    function SearchWods() {
      _ref = SearchWods.__super__.constructor.apply(this, arguments);
      return _ref;
    }
...
(function() {
  ...
  WodEntry = (function(_super) {
    ...
    WodEntry.configure('WodEntry', 'id', 'wod_id', 'name', 'score', 'min', 'sec', 'reps', 'weight', 'method', 'type', 'details', 'date', 'warm-up');
    ...
    WodEntry.history = function(wod) {
      return _.sortBy(WodEntry.byWodId(wod.id), function(entry) {
        return -1 * moment(entry.date).valueOf();
      });
    };
...
(function() {
  ...
  Superfit.EditWod = (function(_super) {
    ...
    EditWod.prototype.takePhoto = function(e) {
      e.preventDefault();
      return this.log("PhoneGap camera integration goes here!");
    };
...
(function() {
  ...
  Superfit.Records = (function(_super) {
    ...
    Records.prototype.recordClicked = function(e) {
      ...
      return Wod.trigger('goToRecord', wod_id);
    };

    Records.prototype.goToRecord = function(wod_id, repMax) {
      ...
      if (hasRecord) {
        ...
        return jQT.goTo('#record-detail', 'fade');
      } else {
        Wod.trigger('editRecord', wod, repMax);
        return jQT.goTo('#edit-record', 'fade');
      }
    };
...
(function() {
  ...
  this.JST["superfit/views/get_started_step2"] = (function(context) {
    return (function() {
      var $o;
      $o = [];
      $o.push("<div class='page' id='get-started-step2'>\n  <div class='content-main orientation'>\n    <div class='content-block'>\n      <h1>See Your Progress</h1>\n      <p>Superfit visually tracks the progress ofBenchmarks, Strength and Common workouts.</p>\n      <img src='./assets/gfx-landing-see-progress.png'>\n      <p class='small'>\n        <strong>TIP:</strong>\n        Set up Goals to configure Superfit to track  what you want to work on. Your Daily Dashboard will display your most recent Goal Activity.\n      </p>\n    </div>\n    <div class='orientation-footer'>\n      <a class='bottomk button slide' href='#get-started-step3'>Next : Set-Up is Simple</a>\n    </div>\n  </div>\n</div>");
      return $o.join("\n").replace(/\s(?:id|class)=(['"])(\1)/mg, "");
    }).call(window.HAML.context(context));
  });;
}).call(this);
